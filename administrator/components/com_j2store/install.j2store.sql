...
-- insert data for countries table
			...
			INSERT INTO `#__j2store_countries` (`country_id`, `country_name`, `country_isocode_2`, `country_isocode_3`, `state`) VALUES
			...
			INSERT INTO `#__j2store_zones` (`zone_id`, `country_id`, `zone_code`, `zone_name`, `state`) VALUES
