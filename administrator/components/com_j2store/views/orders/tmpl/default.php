	...
	<table class="adminlist table table-striped">
		...
		<tbody>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td align="center"><?php echo J2StoreUtilities::number( $row->orderpayment_amount, array( 'thousands'=>'' ) ); ?>
				</td>
				<td align="center"><?php echo $row->orderpayment_type; ?>
				</td>
				<!--
			<td align="center">
			 ...
			 -->
				<td align="center"><?php echo $row->order_state; ?>
				</td>
			</tr>
			<?php
			$k = 1 - $k;
